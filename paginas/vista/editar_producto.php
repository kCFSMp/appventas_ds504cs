                                ...
                                <div class="card-body">
                                    ...
                                    <form id="frm_editar_prod" name="frm_editar_prod" method="post" action="../controlador/ctr_grabar_prod.php" autocomplete="off">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-8">
                                                <label for="txt_prod" class="form-label">Producto</label>
                                                <input type="text" class="form-control" id="txt_prod" name="txt_prod" placeholder="Código" maxlength="50" readonly value="<?=$rs_prod->producto?>" />
                                            </div>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-outline-success" id="btn_registrar_prod" name="btn_registrar_prod">
